...
contract PupperCoinCrowdsale is Crowdsale, MintedCrowdsale, CappedCrowdsale, TimedCrowdsale, RefundablePostDeliveryCrowdsale {
    ...
    constructor(
        ...
        uint rate, // to maintain parity with ETH
...
contract PupperCoinCrowdsaleDeployer {
        ...
        public
    {
        ...
        PupperCoin token = new PupperCoin(_name, symbol, 0);
        token_address = address(token);

        // @TODO: create the PupperCoinCrowdsale and tell it about the token, set the goal, and set the open and close times to now and now + 24 weeks.
